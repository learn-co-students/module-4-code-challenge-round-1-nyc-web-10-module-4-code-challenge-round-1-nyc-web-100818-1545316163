...
1) Get the list of Transactions to display on the page given the transactions data being imported. - DONE

2) After that is working, replace that data with the JSON you fetch from this url [https://boiling-brook-94902.herokuapp.com/transactions](https://boiling-brook-94902.herokuapp.com/transactions). It will be in the same format as the  default data. - DONE
